  ...
  return (
    <div className={rootClass}>
      <div className={rootClass.elem("container")}>
        ...
        <p className={rootClass.elem("description")}>Connect your cloud storage or upload files from your computer</p>
        ...
        <div className={rootClass.elem("actions")}>
          ...
          <Button look="outlined" size="large">
            Import
          </Button>
        </div>

        <a
          href="https://labelstud.io/guide/ingest.html"
          target="_blank"
          rel="noopener noreferrer"
          className={rootClass.elem("link")}
        >
